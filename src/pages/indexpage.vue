<template>
  <div class='layout'>
    <Layout>
      <Sider ref='side1' hide-trigger collapsible style="width:256px;min-width: 256px;max-width: 256px;flex: 0 0 256px;" :collapsed-width='78' v-model='isCollapsed'>
        <div class="index__logo___2J9hf">
...
<script>
import sideMenuItem from "../components/menuItem.vue";
...
.index__logo___2J9hf img {
  display: inline-block;
  vertical-align: middle;
  height: 32px;
}
.index__logo___2J9hf h1 {
  color: white;
  display: inline-block;
  vertical-align: middle;
  font-size: 20px;
